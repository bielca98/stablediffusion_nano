...
export OUTPUT_DIR="/projects/static2dynamic/Biel/stablediffusion_nano/outputs/DMSO_2"
export WEIGHTS_PATH="/projects/static2dynamic/Biel/stablediffusion_nano/test_output/nano_from_scratch_DMSO_2_100"
