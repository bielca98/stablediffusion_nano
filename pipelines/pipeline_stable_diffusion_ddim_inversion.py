...
class StableDiffusionPipelineWithDDIMInversion(ClassConditionedStableDiffusionPipeline):
    def __init__(
        self,
        vae,
        unet,
        ...
        super().__init__(vae, unet, scheduler, feature_extractor, image_encoder)
    ...
    def invert(
        ...
        latents = self.prepare_image_latents(
            image, 1, self.vae.dtype, device, generator
        )
